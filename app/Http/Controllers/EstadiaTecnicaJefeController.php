...
class EstadiaTecnicaJefeController extends Controller
{
    public function viewRequests()
    {
        $estadias = Estadia_Tecnica::where('estatus', 'Sellado')->get();

        return view('estadia.solicitudesJefe', [
            'estadias' => $estadias
        ]);
    }
    ...
    public function viewOneRequest($id)
    {
        ...
        return view('estadia.solicitudJefe', [
            'estadia' => $estadia
        ]);
    }
    ...
    public function changeStatus(Request $request)
    {
        ...
        return redirect()->route('estadia-por-firmar');
    }
}
