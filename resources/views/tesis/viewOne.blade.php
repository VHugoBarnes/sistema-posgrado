<x-guest-layout>
    <div class="container mx-auto bg-gray-200 m-8 w-1/2 rounded">
        ...
        @if ($tesis->director != null)
            <h2 class="text-blue-400 p-2">Director: {{ $tesis->director()->first()->nombre }}</h2>
        @else
        ...
        @if ($tesis->codirector != null)
            <h2 class="text-blue-400 p-2">Codirector: {{ $tesis->codirector()->first()->nombre }}</h2>
        @else
        ...
        @if ($tesis->secretario != null)
            <h2 class="text-blue-400 p-2">Secretario: {{ $tesis->secretario()->first()->nombre }}</h2>
        @else
        ...
        @if ($tesis->vocal != null)
            <h2 class="text-blue-400 p-2">Vocal: {{ $tesis->vocal()->first()->nombre }}</h2>
        @else
