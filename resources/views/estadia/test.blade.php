...
<body>
    ...
    <main>
        <div id="lugar-fecha" align="right">
            <p>H. Matamoros, Tam., 10/06/2021</p>
            <p>Oficio Núm: 081/DEPI/2019</p>
        </div>
        <div id="destinatario">
            <p><b>LIC. Juan Perez</b></p>
            <p><b>CTO</b></p>
            <p><b>Parker</p>
        </div>
        <div id="saludo">
            <p>Por el presente me permito presentar al C. NOMBRE DEL ALUMNO, estudiante de la Maestría en Administración Industrial, con número de control xxxxxxxx y número CVU xxxxxxx, quien solicita la oportunidad de realizar su ESTADÍA TÉCNICA en el área de área donde se realizará el proyecto en su Empresa para realizar el proyecto “Nombre del proyecto”, durante el periodo comprendido de  dd/mm/aaaa a dd/mm/aaaa, esto con la finalidad de complementar su formación académica.</p>
